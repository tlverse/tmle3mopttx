...
used to estimate the blip function. Note that for binary treatment, the most natural
...
to a specific subgroup is optimal, however often (if ever) encountered in the 
