...
tmle3_Spec_mopttx_vim <- R6Class(
  ...
  public = list(
    initialize = function(V=NULL, type="blip2", method="SL", b_learner=NULL, 
      ...
      options <- list(V = V, type = type, method=method, b_learner = b_learner, 
    ...
    make_params = function(tmle_task, likelihood) {
      ...
      if(method=="Q"){
        ...
        opt_rule <- Optimal_Rule$new(tmle_task, likelihood, cv_fold = "split-specific",
                                     V = private$.options$V,         
...
tmle3_mopttx_vim <- function(V=NULL, type="blip2", method="SL", b_learner=NULL, 
                             contrast="linear", maximize=TRUE) {
  tmle3_Spec_mopttx_vim$new(V = V, type = type, method=method, b_learner = b_learner, 
                            contrast = contrast,maximize = maximize)
}
